...
<html>
	...
	<div class="row">
		<div class="login-wrap" style="margin-top: 10px;text-align: center;">
			<div class="login-html col-md-8 col-xs-10 col-md-offset-2 col-xs-offset-1" style="height: 780px;">
				...
				<div class="login-form">
					<div class="sign-in-htm">
						<form id="form1">
							...
							<div class="group">
								<label for="yzm" class="label">验证码</label>
								<input id="yzm" class="input" type="text" required="required">
							</div>
							<div class="group">
								<img id="img" style="width: 160px;height: 50px">
							</div>
							<div class="group">
								<input id="loginbtn" type="button" class="button" disabled="disabled" value="登录">
							</div>
					...
					<input type="hidden" id="hide3" value="0">
						<form id="fomr2">
						<div class="group">
							<label for="candidate" class="label">考号</label>
							<input id="candidate" type="text" name="stuCandidate" class="input">
						</div>
						<div class="group">
							<label for="tel" class="label">电话</label>
							<input id="tel" type="text" name="stuTel" class="input" disabled="disabled">
						</div>
						<div class="group">
						...
						<div class="group">
							<label for="yzm2" class="label">验证码</label>
							<input id="yzm2" type="text" class="input" >
						</div>
						<div class="group">
								<img id="img2" style="width: 160px;height: 50px">
						</div>
						<div class="group">
...
<br><br>
	<div class="col-xs-12" style="text-align: center"><br>版权所有 山东科技大学<sup>&copy;</sup></div>
	...
	$("#loginbtn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				...
				}else if(msg=="stuerror"){
					$("#msg1").css("color","red").addClass("glyphicon glyphicon-remove").text("账户名或密码错误，请重新登录");
				}else if(msg=="managersuccess"){
					window.location.href="${path}/loginSuccess";
				}else if(msg=="managererror"){
					$("#msg1").css("color","red").addClass("glyphicon glyphicon-remove").text("账户名或密码错误，请重新登录");
				}
			}
